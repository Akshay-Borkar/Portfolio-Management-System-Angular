...
function colorStringToRgba(colorString) {
  ...
  }
  {
    ...
    if (matches) {
      return [normalizeRgbComponent(parseInt(matches[1], 16) * 17), normalizeRgbComponent(parseInt(matches[2], 16) * 17), normalizeRgbComponent(parseInt(matches[3], 16) * 17), 1];
    }
  }
...
var animationStagesData = [{
  ...
  /* Constants.Stage1EndStrokeAlpha */
}, {
  ...
  /* Constants.Stage2EndStrokeAlpha */
}, {
  ...
  _internal_endStrokeAlpha: 0
  /* Constants.Stage3EndStrokeAlpha */
}];
...
var MMMM = (date, locale) => new Date(date.getUTCFullYear(), date.getUTCMonth(), 1).toLocaleString(locale, {
  month: "long"
});
var MMM = (date, locale) => new Date(date.getUTCFullYear(), date.getUTCMonth(), 1).toLocaleString(locale, {
  month: "short"
});
...
var TimeAxisWidget = class {
  ...
  _internal_setSizes(timeAxisSize, leftStubWidth, rightStubWidth) {
    ...
    if (this._private__leftStub !== null) {
      this._private__leftStub._internal_setSize(size({
        width: leftStubWidth,
        height: timeAxisSize.height
      }));
    }
    if (this._private__rightStub !== null) {
      this._private__rightStub._internal_setSize(size({
